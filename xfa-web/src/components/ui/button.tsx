  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-primary-foreground hover:scale-105 transform shadow-elegant font-semibold",
        accent: "bg-gradient-accent text-primary-accent-foreground hover:scale-105 transform shadow-elegant font-semibold",
        archery: "bg-navy-primary text-primary-foreground hover:bg-navy-light border-2 border-coral-accent hover:border-coral-light shadow-elegant",
      },
      size: {
